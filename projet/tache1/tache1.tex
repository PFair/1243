...
\section{Sources des réactifs}
	...
	La deuxième version de notre flow-sheet se trouve à la figure (Figure \ref{flow-sheet-v2}).
...
dans le réacteur du  réformage primaire. Et comme on peut poser comme hypothèse
